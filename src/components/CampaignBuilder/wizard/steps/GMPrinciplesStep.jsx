...
export default function GMPrinciplesStep({ value, onChange }) {
  ...
  const generateRandom = () => {
    const generated = templateService.generateGMPrinciples(3);
    onChange(generated);
  };
  ...
  return (
    <WizardStep
      title="GM Principles"
      description="Create 2-5 guiding principles for yourself as the GM running this campaign."
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <div className="form-group">
          <label>GM Principles</label>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <input
              ...
              placeholder="Add a GM principle..."
          ...
          <small className="form-hint">Example: "Show the consequences of corruption spreading"</small>
        </div>
