...
export default function DaggerheartEquipmentCard({ item, onEdit, onDelete, onDeposit, deposited, isDM, isExpanded: controlledExpanded, setIsExpanded: setControlledExpanded }) {
