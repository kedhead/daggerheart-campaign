...
export default function DnD5eCard({ character, onEdit, onDelete, isDM, canEdit }) {
      ...
      {isExpanded && (
        <div className="character-details">
          <div className="character-sheet-link">
            <a
              href={systemData.dndBeyondLink}
              target="_blank"
              rel="noopener noreferrer"
              className="btn btn-primary full-width"
            >
              <ExternalLink size={18} />
              Open Character Sheet on D&D Beyond
            </a>
          </div>
